...
constexpr char *ColorShader = "ColorShader";
...
void NGLScene::initializeGL()
{
  ...
  ngl::ShaderLib::loadShader(ColorShader, "shaders/ColourVertex.glsl", "shaders/ColourFragment.glsl");
...
void NGLScene::paintGL()
{
  ...
  ngl::ShaderLib::use(ColorShader);

  // auto translate = ngl::Mat4::translate(-1.0f,0.0f,0.0f);
  // auto rotate = ngl::Mat4::rotateY(-90.0f);
  ...
  // can add more method to ngl
  // need to reset the transformation load for each frame
  tx.reset();
